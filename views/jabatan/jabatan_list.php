    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('jabatan/read/'.$jabatan->id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('jabatan/update/'.$jabatan->id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('jabatan/delete/'.$jabatan->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
